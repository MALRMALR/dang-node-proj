...
// deprecated uglyify js plugin - use config.optimization.minimize instead (warning) - added 7/4/20 - MALRMALR
...
const config = {
  ...
  // new options due to deprecated uglify-js plugin - added 7/4/20 - MALRMALR
  optimization: {
    minimizer: [
